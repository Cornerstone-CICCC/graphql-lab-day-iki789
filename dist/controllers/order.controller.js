...
const createOrder = (customer) => __awaiter(void 0, void 0, void 0, function* () {
    const newCustomer = new order_model_1.default(customer);
    return yield newCustomer.save();
});
exports.createOrder = createOrder;
const updateOrder = (id, order) => __awaiter(void 0, void 0, void 0, function* () {
    return yield order_model_1.default.findByIdAndUpdate(id, order);
});
